...
class RandomRotateRightAngle(object):
    def __init__(self):
    ...
    def __call__(self, img, mask):
        ...
        if i == 0:
            return img, mask
        rotate_degree = self.degrees[i]
        return img.rotate(rotate_degree), mask.rotate(rotate_degree)
...
class Grayscale(object):
    ...
    def __call__(self, img, mask):
        ...
        return (F.to_grayscale(img, num_output_channels=self.num_output_channels),
                F.to_grayscale(mask, num_output_channels=self.num_output_channels))
